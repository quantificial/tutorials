...
INSERT INTO oauth_client_details (client_id, client_secret, scope, authorized_grant_types, authorities, access_token_validity, refresh_token_validity, web_server_redirect_uri, autoapprove)
  VALUES ('app1', '{bcrypt}$2a$10$w6U0a421YvG8GuVXeVcyk..7Kba/esmX0jNwV2jYYwedKC2CIT7Qy', 'user_info,offline_access', 'authorization_code,refresh_token', 'ROLE_CLIENT', 3600, 3600, 'http://localhost:8082/ui/login', 'true');
...
INSERT INTO oauth_client_details (client_id,resource_ids, client_secret, scope, authorized_grant_types, authorities, access_token_validity,refresh_token_validity, web_server_redirect_uri, autoapprove)
  VALUES ('appalone', 'api', '{bcrypt}$2a$10$w6U0a421YvG8GuVXeVcyk..7Kba/esmX0jNwV2jYYwedKC2CIT7Qy', 'read,write', 'client_credentials,refresh_token', 'ROLE_CLIENT', 15, 15, 'http://localhost:8084/login/sso', 'true'); 
